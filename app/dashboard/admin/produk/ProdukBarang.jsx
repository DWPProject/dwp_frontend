      ...
      {showForm ? (
        ...
        <>
          <div className="bg-white m-5 rounded-lg">
            <h1 className="text-start font-bold text-3xl px-3 pt-5">
              Bank Produk Barang
            </h1>
            ...
            <div className="overflow-x-auto h-fit pb-5 scrollbar-hide">
              <table className="table table-pin-rows">
                ...
                <tfoot className="font-bold text-black">
                  <tr>
                    {TABLE_FOOT_BANK_PRODUK.map((head) => (
                      <th key={head}>{head}</th>
                    ))}
                  </tr>
                </tfoot>
          ...
          <div className="bg-white m-5 rounded-lg">
            ...
            <div className="overflow-x-auto h-fit pb-5 scrollbar-hide">
              <table className="table table-pin-rows">
                ...
                <tfoot className="font-bold text-black">
                  <tr>
                    {TABLE_FOOT_PRODUK_JUAL.map((head) => (
                      <th key={head}>{head}</th>
                    ))}
                  </tr>
                </tfoot>
